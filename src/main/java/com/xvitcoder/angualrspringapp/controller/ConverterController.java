...
public class ConverterController {
	...
	@RequestMapping(value = "/unicode_from_zawgyi/{inputText}", method = RequestMethod.GET,produces = "text/plain;charset=UTF-8")
	public  @ResponseBody String zg12uni51(@PathVariable("inputText")String inputText,HttpServletRequest request) {
