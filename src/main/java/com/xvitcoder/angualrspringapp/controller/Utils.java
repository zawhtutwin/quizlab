...
public class Utils {
	public static void getUnicodeQuestion(Question q){
			q.setQuestionText(zawGyiToUniCode(q.getQuestionText()));
	}
	public static void getUnicodeAnswer(Answer a){	
		 a.setAnswerText(zawGyiToUniCode(a.getAnswerText()));
	}
	public static String zawGyiToUniCode(String output_text){
